...
AstianGO is an open source search engine where the user has the ability to see
...
- _Complete transparency_ -- You can view our code and follow the development
  directly on [Github](https://github.com/goastian/astiango)
- _Privacy focussed_ -- We will never track you. Period. And you can always
  verify this in our [source code.](https://github.com/goastian/astiango)
...
In the future we will have, clearly labelled, contextual ads based on your current search query or keywords and a
