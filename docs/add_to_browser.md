# Adding AstianGO to the Web Browser

While it is not currently recommended to use AstianGO as your primary search option, you can add AstianGO
to your browser by following the instructions listed for your respective browser.

## Chrome

1. Navigate to [astiango.com](https://astiango.com)
...
3. Select `Add "AstianGO Search"`

![Add AstianGO to Search button](../assets/add_browser/firefox_search_1.png)
4. Navigate to Settings
5. Select Search 
6. Use the `Default Search Engine` dropdown to select AstianGO
![Make AstianGO default search](../assets/add_browser/firefox_search_3.png)
...
7. Click the menu next to AstianGO and select `Make default`
![edge make default button](../assets/add_browser/edge_search_4.png)


## Safari 

Safari only allows a small fraction of available search engines as a default search engine; however, you can add AstianGO
...
5. Select astiango.com from the options

![safari website options](../assets/add_browser/safari_search_2.png)


From here astiango.com should appear in the search bar and you can arrow down to
it and begin typing.
![safari AstianGO searching](../assets/add_browser/safari_search_3.png)
